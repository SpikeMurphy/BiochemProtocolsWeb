...
[Primer Designing]({{< relref "primer_designing" >}})
→ [Priemr Reconstitution]({{< relref "primer_reconstitution" >}})
→ [Polymerase Chain Reaction (PCR) with Fusion Hot Start II DNA Polymerase]({{< relref "pcr" >}})
→ [Agarose Gel Electrophoresis Folowing PCR]({{< relref "age_following_pcr" >}})
