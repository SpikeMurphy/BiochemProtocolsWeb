...
| :-- | :-- | :-- | :-- |
| <input type="checkbox"> | <span id="alt_inouetransformationbufferstock10x_r_ms_pipes">PIPES</span>     <span id="alt_inouetransformationbufferstock10x_r_ms_mopes" style="display:none">MOPES</span> | <span id="alt_inouetransformationbufferstock10x_r_vm_pipes">3.00 g</span>     <span id="alt_inouetransformationbufferstock10x_r_vm_mopes" style="display:none">2.10 g</span> | <span id="alt_inouetransformationbufferstock10x_r_mol_pipes">10 mM</span>     <span id="alt_inouetransformationbufferstock10x_r_mol_mopes" style="display:none">10 mM</span> |
| <input type="checkbox"> | MnCl<sub>2</sub> | 10.89 g | 55 mM |
| <input type="checkbox"> | CaCl<sub>2</sub> | 2.20 g | 15 mM |
| <input type="checkbox"> | KCl | 18.65 g | 250 mM |
| <input type="checkbox"> | dsH<sub>2</sub>O | to 800 mL |  |
...
| <input type="checkbox"> | dsH<sub>2</sub>O | to 1000 mL |  |
