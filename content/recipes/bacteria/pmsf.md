+++
date = '2025-12-07T19:00:29+01:00'
draft = false
construction = false
title = 'Phenylmethylsulfonyl Fluoride PMSF Stock 100 mM'
subtitle = ''
author = [
    'Spike Murphy Müller ¹'
]
...
| :-- | :-- |
| [Tris-HCl-NaCl-MgCl2 Bacterial Lysis Buffer]({{< relref "bacterial_lysis_buffer.md" >}}) | Typical concentration of 0.1 (0.1-1) mM for inhibition of serine and cysteine proteases. Working concentrations are only stable for a few hours. |
