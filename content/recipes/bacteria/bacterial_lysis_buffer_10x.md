...
draft = false
construction = false
title = 'Tris-HCl-NaCl-MgCl2 Bacterial Lysis Buffer Stock 10x'
subtitle = ''
...
| :-- | :-- | :-- | :-- |
| <input type="checkbox"> | tris base | 30.3 g | 500 mM (1x: 50 mM) |
| <input type="checkbox"> | NaCl | 43.8 g | 1.5 M (1x: 150 mM) |
| <input type="checkbox"> | MgCl<sub>2</sub> | 5.1 g | 50 mM (1x: 5mM) |
