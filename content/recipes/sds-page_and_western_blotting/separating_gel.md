+++
date = '2025-12-07T20:29:40+01:00'
draft = false
construction = false
title = 'SDS-PAGE Separating Gel'
subtitle = ''
author = [
    'Spike Murphy Müller ¹'
]
...
| :-- | :-- | :-- | :-- |
| {{< checkbox >}} | dsH<sub>2</sub>O | <span class="calc_recipe_amount" data-default-one="4.100">4.100 mL</span> | |
| {{< checkbox >}} | tris-HCl | <span class="calc_recipe_amount" data-default-one="5.640">5.640 mL</span> | 126 mM |
| {{< checkbox >}} | acrylamide | <span class="calc_recipe_amount" data-default-one="5.000">5.000 mL</span> | ~544 mM |
| {{< checkbox >}} | SDS | <span class="calc_recipe_amount" data-default-one="0.150">0.150 mL</span> | 3.5 mM (0.1 %) |
| {{< checkbox >}} | TEMED | <span class="calc_recipe_amount" data-default-one="0.010">0.010 mL</span> | 8.6 mM |
| {{< checkbox >}} | APS | <span class="calc_recipe_amount" data-default-one="0.100">0.100 mL</span> | 6.57 mM |
| {{< checkbox >}} | Σ | = <span class="calc_recipe_amount" data-default-one="15">15 mL</span> | |
