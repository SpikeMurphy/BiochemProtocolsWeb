...
## Procedure:
### Preparing the gel:
1. {{< checkbox >}} Weigh the correct amount of agarose:
...
2. {{< checkbox >}} Add 50 mL of TAE buffer.
3. {{< checkbox >}} Place in microwave and heat in bursts with swaying in between until boiling and until clear.
4. {{< checkbox >}} Let cool down to approximately 50°C in a water bath or under running water until only warm to touch.
5. {{< checkbox >}} Add gel stain.
...
### Casting the Gel:
1. {{< checkbox >}} Place the casting tray into the gel chamber rotated 90° to prevent the gel from running in the chamber.
2. {{< checkbox >}} Place the well comb.
3. {{< checkbox >}} Pour in the gel from a corner on the opposite site from the well comb.
4. {{< checkbox >}} Remove all bubbles, especially near the comb or where the DNA will be running, if necessary.
5. {{< checkbox >}} Let the gel solidify for approximately 30 minutes.
...
{{< /infobox >}}
1. {{< checkbox >}} Prepare a Mastermix:
...
| :-- | :-- | :-- | :-- | :-- | :-- |
| {{< checkbox >}} | <span  id="buffer-vol" class="age_mm" data-base="1">1</span> µL | DNA loading buffer | {{< calculators/age_mastermix_buffer_select target="buffer-vol" >}} |  |
| {{< checkbox >}} | <span id="h2o-vol" class="age_mm" data-base="3">3</span> µL | dsH<sub>2</sub>O |  |  |
| {{< checkbox >}} | = <span class="age_mm" data-base="4">4</span> µL |  |  |  |  
...
2.	{{< checkbox >}} Mix the DNA and the loading buffer to a final volume according to the capacity of the wells:

|  | Volume V [µL] | Reagent | Concentration c<sub>1</sub> [ng/µL] <br> Mass m<sub>1</sub> [ng] | Concentration c<sub>2</sub> [ng/µL] <br> Mass m<sub>2</sub> [ng] |
| :-- | :-- | :-- | :-- | :-- |
| {{< checkbox >}} | <span class="age_sample" data-base="4">4</span> µL | DNA loading buffer mastermix |  | 1x |
| {{< checkbox >}} | <span class="age_sample" data-base="1">1</span> µL | DNA sample | minimum 20 ng/µL | minimum 20 ng |
| {{< checkbox >}} | = <span class="age_sample" data-base="5">5</span> µL |  |  |  |
...
### Running the Gel:
1.	{{< checkbox >}} Rotate the casting tray 90° so the gel pockets are oriented towards the cathode (black).
{{< infobox type="info" title="" >}}
DNA is negatively charged and runs from the cathode (-) to the anode (+).
{{< /infobox >}}

2.	{{< checkbox >}} Fill the electrophoresis chamber with TAE buffer until the gel is overlain.
3.	{{< checkbox >}} Pipet the DNA ladder in the first (and last) well(s).
4.	{{< checkbox >}} Pipet the samples into the other wells.
5.	{{< checkbox >}} Let the gel run at the indicated voltage below (default 80 V) for approximately 1 hour depending on the gels percentage.
...
- [Imaging following agarose gel electrophoresis (AGE)]({{< relref "methods/dna/imaging_age.md" >}})
- [Purification of DNA from agarose gel electrophoresis (AGE)]({{< relref "methods/dna/purification_age.md" >}})
{{< /tab >}}
