...
| :-- | :-- | :-- | :-- | :-- |
| {{< checkbox >}} | <span class="pcr" data-base="30.5">30.5</span> µL | dsH<sub>2</sub>O |  |  |
| {{< checkbox >}} | <span class="pcr" data-base="10">10</span> µL | GC buffer | 5x | 1x |
| {{< checkbox >}} | <span class="pcr" data-base="1.5">1.5</span> µL | DMSO | 100 % |  |
| {{< checkbox >}} | <span class="pcr" data-base="1">1</span> µL | dNTP mix | 10 mM | 200 µM |
|  | = <span class="pcr" data-base="43">43</span> µL |  |  |  |
{{< calculators/pcr_mastermix_prep_calc >}}
2. {{< checkbox >}} Prepare samples with mastermix by pipetting the following volumes into a 0.5 mL PCR tube:

|  | Volume V [µL] | Reagent | c<sub>1</sub>/m<sub>1</sub> | c<sub>2</sub>/m<sub>2</sub> |
| :-- | :-- | :-- | :-- | :-- |
| {{< checkbox >}} | 43 µL  | Mastermix |  |  |
| {{< checkbox >}} | 2.5 µL| Forward Primer | 10 µM | 0.5µM |
| {{< checkbox >}} | 2.5 µL| Reverse Primer | 10 µM | 0.5µM |
| {{< checkbox >}} | 1 µL | DNA Template | 10 ng/µL | 200 pg/µL |
| {{< checkbox >}} | 1 µL | Phusion Hot Start II DNA Polymerase| 2 U/µL | 2 U |
|  | = 50 µL |  |  |  |  

Alternatively prepare samples individually by pipetting the following volumes into a 0.5 mL PCR tube:  
|  | Volume V [µL] | Reagent | c<sub>1</sub>/m<sub>1</sub> | c<sub>2</sub>/m<sub>2</sub> |
| :-- | :-- | :-- | :-- | :-- |
| {{< checkbox >}} | 30.5 µL | dsH<sub>2</sub>O |  |  |
| {{< checkbox >}} | 10 µL | GC buffer | 5x | 1x |
| {{< checkbox >}} | 1.5 µL | DMSO | 100 % |  |
| {{< checkbox >}} | 1 µL | dNTP mix | 10 mM | 200 µM |
| {{< checkbox >}} | 2.5 µL| Forward Primer | 10 µM | 0.5µM |
| {{< checkbox >}} | 2.5 µL| Reverse Primer | 10 µM | 0.5µM |
| {{< checkbox >}} | 1 µL | DNA Template | 10 ng/µL | 200 pg/µL |
| {{< checkbox >}} | 1 µL | Phusion Hot Start II DNA Polymerase| 2 U/µL | 2 U |
...
2. {{< checkbox >}} Place the PCR tubes into the Thermocycler with maximum disance between samples.
3. {{< checkbox >}} Start the PCR program.

### Procede with Suitable Protocol:
- [Agarose Gel Electrophoresis (AGE)]({{< relref "methods/dna/age.md" >}})
{{< /tab >}}
